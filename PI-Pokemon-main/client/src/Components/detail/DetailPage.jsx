...
const DetailPage = () => {
  ...
  <div>
    ...
    {/* Verificación para evitar errores si pokemon.types es undefined o null */}
    <p>Tipo: {pokemon.types && pokemon.types.map((type) => type.name).join(', ')}</p>

    {/* Agrega el botón para volver a la home */}
    <button onClick={handleGoBack}>Volver a la Home</button>
  </div>
) : (
  <p>Cargando...</p>
)}
